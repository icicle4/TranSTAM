...
if __name__ == '__main__':
    ...
    for gtfile in gtfiles:
        gt_video_name = gtfile.split('/')[-3]
        if os.path.exists(os.path.join(args.tests, '{}.txt'.format(gt_video_name))):
            gt_video_names.append(gt_video_name)
            tsfiles.append(os.path.join(args.tests, '{}.txt'.format(gt_video_name)))
